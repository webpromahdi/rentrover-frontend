    ...
    <SheetPortal>
      ...
      <SheetPrimitive.Popup
        ...
        className={cn(
           ...
           * translate-full (100% of the panel's own dimension) instead of the
           * previous fixed 40px offset. The panel now clearly emerges from and
           * returns to its edge regardless of viewport height.
           * Duration/easing unchanged. Reduced motion: transform suppressed globally.
           */
